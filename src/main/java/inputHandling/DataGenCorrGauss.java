...
/**
 * Generate Gaussian Distributed light correlated Data
 ...
 *
 */
public class DataGenCorrGauss implements DataGenInterface{
	private static final Logger logger = Logger.getLogger(DataGenCorrGauss.class.getName());
	private long seed;
	 ...
	 * @param seed
	 */
	public DataGenCorrGauss(long seed) {
		this.seed = seed;
	}
	 ...
	 */
	public DataGenCorrGauss(long seed, float std, float center){
		this(seed);
		this.std = std;
		this.center = center;		
	}
	 ...
	 * @param center center of the distribution
	 */
	public DataGenCorrGauss(float std, float center){
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;		
	}
	...
	public TupleList genData(int dimensions, int tupleCount) {
		logger.info("Generating gaussian correlated Data with " + tupleCount + " Tuples in " + dimensions + " dimensions");
