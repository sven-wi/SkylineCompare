...
/**
 * Generator for strong Anti-Correlated Data, with the gaussian Generators from the Apache.Commons Framework.
 * @author Sven Wiemann
 *
 */
public class DataGenAntiCorrGaussCommons implements DataGenInterface{
	 ...
	 * @param seed
	 */
	public DataGenAntiCorrGaussCommons(long seed) {
		this.seed = seed;
	}
	 ...
	 */
	public DataGenAntiCorrGaussCommons() {
	 ...
	 * @param center
	 */
	public DataGenAntiCorrGaussCommons(long seed, float std, float center) {
		this.seed = seed;
		this.std = std;
		this.center = center;
	}
	 ...
	 * @param center
	 */
	public DataGenAntiCorrGaussCommons(float std, float center) {
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;
	}
	
	public DataGenAntiCorrGaussCommons(long seed, float std, float center, double coeff) {
		this.seed = seed;
		this.std = std;
		this.center = center;
		this.coeff = coeff;
	...
	public DataGenAntiCorrGaussCommons(float std, float center, double coeff) {
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;
		this.coeff = coeff;
	...
	public DataGenAntiCorrGaussCommons(long seed, double coeff) {
		this.seed = seed;
		this.coeff = coeff;
	}
	
	public DataGenAntiCorrGaussCommons(double coeff) {
		this(System.currentTimeMillis());
		this.coeff = coeff;
	}
	...
	public TupleList genData(int dimensions, int tupleCount) {
		logger.info("Generating gaussian anti-correlated Data with " + tupleCount + " Tuples in " + dimensions + " dimensions, Coeff.: -" + this.coeff);
