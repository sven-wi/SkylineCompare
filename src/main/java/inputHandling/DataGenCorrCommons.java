 ...
 *
 */
public class DataGenCorrCommons implements DataGenInterface{
	 ...
	 * @param seed
	 */
	public DataGenCorrCommons(long seed) {
		this.seed = seed;
	}
	 ...
	 * @param center
	 */
	public DataGenCorrCommons(long seed, float std, float center) {
		this.seed = seed;
		this.std = std;
		this.center = center;
	}
	 ...
	 * @param center
	 */
	public DataGenCorrCommons(float std, float center) {
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;
	}
	
	public DataGenCorrCommons(long seed, float std, float center, double coeff) {
		this.seed = seed;
		this.std = std;
		this.center = center;
		this.coeff = coeff;
	...
	public DataGenCorrCommons(float std, float center, double coeff) {
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;
		this.coeff = coeff;
	...
	public DataGenCorrCommons(long seed, double coeff) {
		this.seed = seed;
		this.coeff = coeff;
	}
	
	public DataGenCorrCommons(double coeff) {
		this(System.currentTimeMillis());
		this.coeff = coeff;
	}
	...
	public TupleList genData(int dimensions, int tupleCount) {
		logger.info("Generating uniform correlated Data with " + tupleCount + " Tuples in " + dimensions + " dimensions, Coeff.: -" + this.coeff);
