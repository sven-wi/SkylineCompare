...
/**
 * Generator for Correlated Data, with the Generators from the Apache.Commons Framework.
 * @author Sven Wiemann
 *
 */
public class DataGenCorrGaussCommons implements DataGenInterface{
	 ...
	 * @param seed
	 */
	public DataGenCorrGaussCommons(long seed) {
		this.seed = seed;
	}
	 ...
	 */
	public DataGenCorrGaussCommons() {
	 ...
	 * @param center
	 */
	public DataGenCorrGaussCommons(long seed, float std, float center) {
		this.seed = seed;
		this.std = std;
		this.center = center;
	}
	 ...
	 * @param center
	 */
	public DataGenCorrGaussCommons(float std, float center) {
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;
	}
	
	public DataGenCorrGaussCommons(long seed, float std, float center, double coeff) {
		this.seed = seed;
		this.std = std;
		this.center = center;
		this.coeff = coeff;
	...
	public DataGenCorrGaussCommons(float std, float center, double coeff) {
		this(System.currentTimeMillis());
		this.std = std;
		this.center = center;
		this.coeff = coeff;
	...
	public DataGenCorrGaussCommons(long seed, double coeff) {
		this.seed = seed;
		this.coeff = coeff;
	}
	
	public DataGenCorrGaussCommons(double coeff) {
		this(System.currentTimeMillis());
		this.coeff = coeff;
	}
	...
	public TupleList genData(int dimensions, int tupleCount) {
		logger.info("Generating gaussian correlated Data with " + tupleCount + " Tuples in " + dimensions + " dimensions, Coeff.: -" + this.coeff);
